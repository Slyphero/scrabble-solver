...
struct State 
{
    ...
    State(const Player &_player, Gaddag *_currentGaddag, 
          const Board &_board, const Position &_currentPosition, 
          bool _isPlusHasBeenFound) : player(_player), 
                                      currentGaddag(_currentGaddag),
                                      board(_board), 
                                      currentPosition(_currentPosition),
                                      isPlusHasBeenFound(_isPlusHasBeenFound) {}

    State(const State &other) : player(other.player),
