...
struct Bonus 
{
    ...
    Bonus() : letter_factor(1), word_factor(1) {}

    // initialization with provided factors
    //  * lf is the letter factor
    //  * wf is the word factor
    Bonus(unsigned char lf, unsigned char wf) : letter_factor(lf), word_factor(wf) {}

    Bonus(const Bonus &other) : letter_factor(other.letter_factor), 
                                word_factor(other.word_factor) {}
